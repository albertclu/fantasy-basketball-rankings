        ...
        return `
              <tr>
                      <td class="rank">#${index + 1}</td>
                              h<td class="team-name"hh><a<a href="https://fantasy.espn.com/basketball/team?leagueId=` + LEAGUE_ID + `&teamId=` + (TEAM_ID_MAP[team.name] || '') + `" target="_blank" style="color: inherit; text-decoration: none;">` + team.name + `</a>
